    ...
    public partial class LineGraph : AnimatedControl
    {
        ...
        protected override void OnPaintBackground(PaintEventArgs pe)
        {
            ...
            if(m_Data != null && m_Data.Length > 0)
            {
                ...
                int a = (int)((m_Graph.Image.Height - DataPointRadius) * (1 - (m_Data.Average() - minVal) / range));
                a += (int)((m_Graph.Image.Height - DataPointRadius - a) * scoot);
                int vu = (int)((m_Graph.Image.Height - DataPointRadius) * (1 - (m_Data.Average() + m_Data.StandardDeviation()  - minVal) / range));
                vu += (int)((m_Graph.Image.Height - DataPointRadius - vu) * scoot);
                int vd = (int)((m_Graph.Image.Height - DataPointRadius) * (1 - (m_Data.Average() - m_Data.StandardDeviation() - minVal) / range));
                ...
                m_Graph.Graphics.DrawString("Range: {" + minVal.ToString() + "," + maxVal.ToString() + "} mu: " + m_Data.Average().ToString() + " sig: " + m_Data.StandardDeviation().ToString(), m_SmallFont, Brushes.White, 5, this.ClientSize.Height - 5 - m_SmallFont.Height);
            }
